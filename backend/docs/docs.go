    ...
    "paths": {
        ...
        "/api/chat/web-search": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Web search chat response",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/rag": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Rag content",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RagData"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/rag/search": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Similar data found",
                        "schema": {
                            "type": "object",
    ...
    "definitions": {
        "models.ChatRequest": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "can you talk a little bit about my grandfather story?"
                },
                "model": {
                    "type": "string"
                }
        ...
        "models.RagData": {
            ...
            "properties": {
                "content": {
                    "type": "string",
                    "example": "Every family has that one recipe..."
                },
                "content_name": {
                    "type": "string"
                },
